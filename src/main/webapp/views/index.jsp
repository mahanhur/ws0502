                    ...
                    <c:choose>
                        <c:when test="${loginadm == null}">
                            <li class="nav-item dropdown no-arrow">
                                <a href="/login" role="button"><span class="mr-2 d-none d-lg-inline text-gray-600 small">LOGIN</span></a>
                            </li>
                            <li class="nav-item dropdown no-arrow">
                                <a href="/register" role="button"><span class="mr-2 d-none d-lg-inline text-gray-600 small">REGISTER</span></a>
                            </li>
                        </c:when>
                        <c:otherwise>
